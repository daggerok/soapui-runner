...
For example, to execute SoapUI tests using testrunner (version: 5.1.2) tool you can use these commands:

==== running tests on windows

[source,cmd]
----
C:\path\to\SoapUI-5.1.2\bin\testrunner.bat C:\path\to\soapui-test-project.xml
----
...
[source,bash]
----
/path/to/SoapUI-5.1.2.app/Contents/Resources/app/bin/testrunner.sh /path/to/soapui-test-project.xml
----
...
plugins {
  id 'io.github.daggerok.soapui-runner' version '5.1.2'
}
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.io.github.daggerok:soapui-runner:5.1.2'
  }
}
