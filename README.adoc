...
For example, to execute SoapUI tests using testrunner (version: 5.2.0) tool you can use these commands:

==== running tests on windows

[source,cmd]
----
C:\path\to\SoapUI-5.2.0\bin\testrunner.bat C:\path\to\soapui-test-project.xml
----
...
[source,bash]
----
/path/to/SoapUI-5.2.0.app/Contents/Resources/app/bin/testrunner.sh /path/to/soapui-test-project.xml
----
...
plugins {
  id 'io.github.daggerok.soapui-runner' version '5.2.0'
}
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.io.github.daggerok:soapui-runner:5.2.0'
  }
}
