...
plugins {
  id 'io.github.daggerok.soapui-runner' version '5.3.0-0'
}
----
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.io.github.daggerok:soapui-runner:5.3.0-0'
  }
}
...
=== link:https://github.com/daggerok/soapui-runner/releases/tag/5.3.0[5.3.0 (plugin: 5.3.0-0)]
