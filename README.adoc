...
=== link:https://github.com/daggerok/soapui-runner/releases/tag/5.3.0[5.3.0]

==== current milestone version

=== link:https://github.com/daggerok/soapui-runner/releases/tag/5.3.1-RC[5.3.1-RC]

==== support old versions

- *5.2:* 5.2.1, 5.2.0
- *5.1:* 5.1.3, 5.1.2-hotfix.2, 5.1.2
- *5.0:* 5.0.1-hotfix.0 (5.0.0-beta), [line-through]#5.0.1#, 5.0.0-hotfix.1, 5.0.0-hotfix.0, [line-through]#5.0.0#
- *4.6:* 4.6.4-hotfix.0, [line-through]#4.6.4#, 4.6.3, 4.6.2, 4.6.1
