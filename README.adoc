...
For example, to execute SoapUI tests using testrunner (version: 5.0.0) tool you can use these commands:

==== running tests on windows

[source,cmd]
----
C:\path\to\SoapUI-5.0.0\bin\testrunner.bat C:\path\to\soapui-test-project.xml
----
...
[source,bash]
----
/path/to/SoapUI-5.0.0.app/Contents/Resources/app/bin/testrunner.sh /path/to/soapui-test-project.xml
----
